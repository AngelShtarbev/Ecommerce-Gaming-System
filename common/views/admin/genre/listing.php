            ...
            <div class="box-content">
                <form action="" method="get" class="form-horizontal" enctype="multipart/form-data">
                    <fieldset>
                        ...
                        <div class="control-group">
                            <label class="control-label" for="selectError3">Filter Genres</label>
                            <div class="controls">
                                <select id="selectError3" name="orderBy">
                                    <option value="0" <?php echo ($orderBy == 0)? "selected" : " " ?>>-- Select Order --</option>
                                    <option value="1" <?php echo ($orderBy == 1)? "selected" : " " ?>>Genre Name Up</option>
                                    <option value="2" <?php echo ($orderBy == 2)? "selected" : " " ?>>Genre Name Down</option>
                                </select>
                            </div>
                        </div
                ...
                <a href="index.php?c=genre&m=create" class="btn btn-large btn-success pull-right">Create genre</a>
                <table class="table table-striped">
                    ...
                    <?php foreach($genres as $genre): ?>
                        <tr>
                            <td><?php echo $genre->getGenre(); ?></td>
                            <td class="center">
                                <a class="btn btn-info" href="index.php?c=genre&m=update&id=<?php echo $genre->getId(); ?>">
                                    <i class="halflings-icon white edit"></i>
                                </a>
                                <a class="btn btn-danger" href="index.php?c=genre&m=delete&id=<?php echo $genre->getId(); ?>">
